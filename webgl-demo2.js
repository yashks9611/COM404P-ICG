...
function main() {
  ...
  `;
    ...
    const texture1 = loadTexture(gl, 'curie.jpg');
    const texture2 = loadTexture(gl, 'JCB.png');
    const texture3 = loadTexture(gl, 'bhabha.jpg');
    const texture4 = loadTexture(gl, 'nobel.jpg');
    const texture5 = loadTexture(gl, 'hawking.jpg');
    var then = 0;
    ...
    function render(now) {
        ...
        drawScene(gl, programInfo, buffers, texture, deltaTime, 0);
...
// Draw the scene.
//
function drawScene(gl, programInfo, buffers, texture, deltaTime, off) {
    if (off == 0) {
